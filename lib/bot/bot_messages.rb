...
Above example will start mid difficulty game with 10 rounds, 30s for answer, from 2 to 3 numbers in riddle and 60s registration time.
Limits => number_of_rounds: 1-20, round_time: 3s-120s, game_start_delay: 10s-120s
