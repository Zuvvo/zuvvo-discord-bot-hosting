class MathGameRiddle
  ...
  attr_accessor :game_host_name, :game_winner, :equation, :time, :answer_time, :difficulty, :game_index, :result

  def initialize(host_name, winner, time, answer_time, difficulty, game_index)
